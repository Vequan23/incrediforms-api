...
const deletePromptFile = async (req: RequestWithUser, res: Response) => {
  const promptFile = await formsService.deletePromptFile(req.params.id, req.params.promptFileId);
